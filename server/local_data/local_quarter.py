...
def calculate_weekly_averages(df):
    ...
    for (date,), month_df in grouped:
        ...
        azteca_avg = round(month_df[azteca_columns + competition_columns][month_df[azteca_columns + competition_columns] != 0].mean(axis=1).mean(), 1)
        competition_avg = round(month_df[azteca_columns + competition_columns][month_df[azteca_columns + competition_columns] != 0].mean(axis=1).mean(), 1)
        azteca_avg_video = round(month_df[[col for col in azteca_columns + competition_columns if 'Video' in col]][month_df[[col for col in azteca_columns + competition_columns if 'Video' in col]] != 0].mean(axis=1).mean(), 1)
        competition_avg_video = round(month_df[[col for col in azteca_columns + competition_columns if 'Video' in col]][month_df[[col for col in azteca_columns + competition_columns if 'Video' in col]] != 0].mean(axis=1).mean(), 1)
        azteca_avg_note = round(month_df[[col for col in azteca_columns + competition_columns if 'Note' in col]][month_df[[col for col in azteca_columns + competition_columns if 'Note' in col]] != 0].mean(axis=1).mean(), 1)
        competition_avg_note = round(month_df[[col for col in azteca_columns + competition_columns if 'Note' in col]][month_df[[col for col in azteca_columns + competition_columns if 'Note' in col]] != 0].mean(axis=1).mean(), 1)
